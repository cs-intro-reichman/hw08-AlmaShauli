public class CombinedOperationsTester {
    ...
    private static void performOperations(PlayList playList) {
        ...
        // Since we can't directly print sorted tracks, let's focus on aspects we can
        // test
        ...
        System.out
                .println("Final Total Duration after additional operations: " + playList.totalDuration() + " seconds");
    }
